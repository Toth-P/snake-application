...
//            if (checkX(maxCoordinate, end.getX() - start.getX(), direction) && checkY(maxCoordinate, end.getY() - start.getY(), direction)) {
//                result = direction;
//            }
//        }
//        if (result == null) {
...
//        return (diff == directionDiff) || (diff - maxCoordinate == directionDiff) || (maxCoordinate + diff == directionDiff);
//    }
